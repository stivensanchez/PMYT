...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { info_id: @measure.info_id, medidas: @measure.medidas, tolerancia: @measure.tolerancia }
    end
  ...
  test "should update measure" do
    patch :update, id: @measure, measure: { info_id: @measure.info_id, medidas: @measure.medidas, tolerancia: @measure.tolerancia }
    assert_redirected_to measure_path(assigns(:measure))
  end
